 ...
 public function getNotAdmin()
    ...
    public function postSettingsUpdate()
    {
      ...
      if(isset($_POST['occupation']))
       ...
       $email_verification=$my_data['email_verification'];
