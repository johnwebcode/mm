                       ...
                       <div class="down-part down1 pdng25">
                           ...
                           <div class="down-part down5 pdng25">
                              <div id="collapse24" style="display:none">
								 ...
								 <div class="row">
                                    <div class="col-lg-6">
                                       <input name="fathers_status" type="text" class="field m-b0" id="FathersStatus1" placeholder="Father's Name" >
                                    </div>
                                    <div class="col-lg-6">
                                       <input name="mothers_status" type="text" class="field m-b0" id="MothersStatus" placeholder="Mother's Name" >
                                    </div>
									</div>
									<div class="row">
                                    <div class="col-lg-6">
