						   ...
						   <div class="login-innerpart">
                               ...
                               <input type="text" placeholder="Email" class="field3" name="email">
											...
											<input type="password" placeholder="password" class="field3" name="password">
												<input class="login-checkbox" type="checkbox" id="fail" tabindex="3"  value="on" name="remember">
												<label for="fail" class="login-label searchlbl" id="fail">Keep me logged in</label><br>
