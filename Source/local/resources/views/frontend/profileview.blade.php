                                ...
                                <form class="form-class"  id="family_details_form">
                                  <div class="prof-sec" id="family_dtls_hide" style="display:none">
										...
										<div class="row pdng25">
											<div class="col-md-4">
												Father Status :<br>
												<input class="einput" type="text" name="fathers_status"  id="FathersStatus1" placeholder="Father's Name" value="<?php echo $user->fathers_status; ?>">
											...
											<div class="col-md-4">
												Mother Status :<br>
												<input class="einput" type="text" name="mothers_status"  id="MothersStatus" placeholder="Mother's Name" value="<?php echo $user->mothers_status; ?>">
