                           ...
                           <div class="tab-pane <?php echo $delete_tab; ?>" id="dltprfl">
                              ...
                              <form id="delete_prf" novalidate="novalidate">
                                 <ul class="liststyle-none">
                                    <li><input id="3-1" type="radio" class="search-check" name="reason" value="married">
                                    <label for="3-1" class="search-check searchlbl">Married</label></li>
                                    <li><input id="3-2"  type="radio" name="reason" value="mrg_fixed">
                                    <label for="3-2" class="search-check searchlbl">Marriage Fixed</label></li>
                                    <li><input id="3-3"  type="radio" name="reason" value="other_reasons">
                                    <label for="3-3" class="search-check searchlbl">Other Reasons</label></li>
                                 </ul>
								 
                                 <p><b>Select a source</b></p>
                                 
                                 <ul class="liststyle-none">
                                    <li><input id="3-4" type="radio" name="source" value="soulmate">
                                    <label for="3-4" class="search-check searchlbl">Through Solmate</label> </li>
                                    <li><input id="3-5" type="radio" name="source" value="other_site">
                                      <label for="3-5" class="search-check searchlbl">Through Other Site</label></li>
                                    <li><input id="3-6" type="radio" name="source" value="other_source">
                                    <label for="3-6" class="search-check searchlbl">Through Other Source</label></li>
                                 </ul>
							...
							$.ajax({
								   ...
								   console.log(email_change);
									   ...
									   else
									   {
										 ...
										 $(".email_show").html('<div class="alert alert-danger">EmailId already exist or Email settings off</div>');
                                           setTimeout(function(){$(".email_show").hide(); }, 3000);
									   }
										 	}
									 });
