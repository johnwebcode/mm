                  ...
                  <div class="col-md-9">
                     ...
                     <div class="nav_clm2">
						...
						<div><div class="usrname"> <input class="field1 login-field" name="email" type="text" placeholder="Email"></div></div>
							...
							<div>
							<input type="checkbox" class="login-checkbox search-check" id="remember" tabindex="3"  value="on" name="remember">
							<label for="remember" class="search-check searchlbl headerpara">&nbsp; Keep me logged in</label></div>
						</div>
